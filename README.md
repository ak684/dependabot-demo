...
1. **Secrets needed** (Settings → Secrets → Actions):
   ...
   **Available OpenHands models:**
   ...
   | Model | Description |
   |-------|-------------|
   | `openhands/gpt-4o` | GPT-4o (default) |
   | `openhands/gpt-4-turbo` | GPT-4 Turbo |
   | `openhands/gpt-5-mini-2025-08-07` | GPT-5 Mini |
   | `openhands/o3` | O3 reasoning model |
   | `openhands/o4-mini` | O4 Mini |
